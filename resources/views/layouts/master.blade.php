			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						<!-- logo -->
						<div class="site-logo">
							<a href="{{route('index')}}"><img src="/images/logo.jpg" alt=""></a>
						</div>
						<!-- logo -->
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="{{route('index-auction')}}">AUCTIONS</a></li>
								...
								<li>
									<form class="form-inline my-2 my-lg-0" action="{{ route('search') }}" method="GET">
										<input class="form-control mr-sm-2" type="search" name="search" placeholder="Search for an auction..." aria-label="Search">
