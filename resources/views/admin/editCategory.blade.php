        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="div_center">
                    ...
                    <h1 class="font_size">Edit Category</h1>
                    ...
                    <form action="{{ route('admin.update-category', $category->id) }}" method='POST'>
                        ...
                        <input type="text" class="border border-gray-200 rounded p-2 w-full" name="name" value="{{ $category->name }}" placeholder="Enter category name"/>
