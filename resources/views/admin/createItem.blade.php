        ...
        <div class="main-panel">
            <div class="content-wrapper">
                ...
                <div class="div_center">
                    <h1 class="font_size">Add New Lot Item</h1>

                    <form action="{{ route('admin.store-item', $auction->id) }}" method="POST" enctype="multipart/form-data" >
                        ...
                        <div class="div_design">
                            ...
                            <input type="text" class="border border-gray-200 rounded p-2 w-full" name="year_produced" value="{{ old('year_produced') }}"/>
                        ...
                        <div class="div_design">
                            ...
                            <input type="text" class="border border-gray-200 rounded p-2 w-full" name="subject_classification" value="{{ old('subject_classification') }}"/>
                        ...
                        <div class="div_design">
                            ...
                            <input type="text" class="border border-gray-200 rounded p-2 w-full" name="estimated_price" value="{{ old('estimated_price') }}"/>
                        ...
                        <div class="div_design">
                            ...
                            <input type="text" class="border border-gray-200 rounded p-2 w-full" name="description_summary" value="{{ old('description_summary') }}"/>
                        ...
                        <div class="div_design">
                            ...
                            <input type="text" class=" field_visibility medium border border-gray-200 rounded p-2 w-full" name="medium" value="{{ old('medium') }}"/>
                        ...
                        <div class="div_design">
                            ...
                            <input type="radio" class="field_visibility is_framed" name="is_framed" id="yes" value="YES" />
                            <label class="field_visibility is_framed" for="yes">
                              YES
                            </label>

                            <input type="radio" class="field_visibility is_framed" name="is_framed" id="no" value="NO" />
                        ...
                        <div class="div_design">
                            ...
                            <input type="text" class="field_visibility dimension border-gray-200 rounded p-2 w-full" name="dimension" value="{{ old('dimension') }}"/>
                        ...
                        <div class="div_design">
                            ...
                            <input type="text" class="field_visibility image_type border-gray-200 rounded p-2 w-full" name="image_type" value="{{ old('image_type') }}"/>
                        ...
                        <div class="div_design">
                            ...
                            <input type="text" class="field_visibility material_used border-gray-200 rounded p-2 w-full" name="material_used" value="{{ old('material_used') }}"/>
                        ...
                        <div class="div_design">
                            ...
                            <input type="text" class="field_visibility weight border-gray-200 rounded p-2 w-full" name="weight" value="{{ old('weight') }}"/>
